...
These principles are not in conflict with open collaboration; they protect contributors, maintainers, and downstream operators from legal and ethical exposure.
...
This Code of Conduct applies within all community spaces (issues, pull requests, discussions, code reviews, documentation) and also applies when an individual is officially representing the community in public spaces.

## Reporting

Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the project maintainers at **security@gildofj.dev**.
...
This Code of Conduct is adapted from the [Contributor Covenant, version 2.1](https://www.contributor-covenant.org/version/2/1/code_of_conduct.html). The "Ethical Use of This Project" section is original to this project.
